...
Most of these come down to network reality or how topica serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

topica rate-limits like any public site. topica already paces
...
Where a surface is gated, topica reads a cookie or token you supply
...
`topica`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what topica actually did
